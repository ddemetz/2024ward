var allReps = [
  ...
  {name:'Austin Bruckner Carrillo',identification:'austinbrucknercarrillo',age:'30',county:'Alameda',state:'California',seat:'LA County Supervisor of District 5',photoSrc:'',repreZent:'FALSE',contact:{website:'https://www.Brucknercarrillo.com',x:'abc4husd',instagram:'abc4husd',tiktok:'',facebook:'austin.bruckner.9'},bio:'Austin Bruckner Carrillo is a 30 year old Commissioner on his city’s Community Services Commission. As a young man raised in a Puerto Rican Italian family household who is passionate about his community, Austin’s top priority if elected to the school board is to address the high truancy and low graduation rates. In addition, Austin is passionate about fortifying ctitical mental health services, protecting children from domestic violence, and encouraging student activism. If elected, Austin would put students first to ensure each student gets the opportunity to complete their education safely, happily, and with all needed support.'},
