var allReps = [
  ...
  {
    name: "Alex Lee",
    identification: "alexlee",
    age: 29,
    county: "Alameda/Santa Clara",
    state: "California",
    photoSrc:
      "https://sanjosespotlight.s3.us-east-2.amazonaws.com/wp-content/uploads/2020/10/12231918/Alex-Lee-cropped.jpg",
    repreZent: "TRUE",
    contact: {
      website: "https://www.votealexlee.com",
      x: "alex_lee",
      instagram: "alex_lee",
      tiktok: "votealexlee",
      facebook: "https://www.facebook.com/votealexlee",
    },
    bio: "Alex Lee is a 29 year old Asian American legislator running for California State Assembly District 24. As an incumbent who was the first openly elected bisexual legislator in California history, Alex Lee stands for housing reform, environmental safety, and electoral reform. In his tenure, Alex authored three social housing bills to realize social housing as a human right, created an environmental justice advisory committee for marginalized communities disproportionately impacted by pesticides, and authored several campaign financing reform bills to ban the excessive influence of corporate money in politics. If reelected, he is dedicated to continuing his fight for the families and workers in his district and his work in creating healthcare, housing, and education for all.",
  },
  {
    name: "Joe Thompson",
    identification: "joethompson",
    age: 21,
    county: "Santa Cruz",
    state: "California",
    photoSrc:
      "https://images.squarespace-cdn.com/content/v1/6039432b1f01154dbf7d4fca/d8464954-93a9-4591-9e62-8051668010a2/Joe+Thompson+Headshot?format=2500w",
    repreZent: "TRUE",
    contact: {
      website: "https://votejoethompson.com/",
      x: "JoeThompsonCA",
      instagram: "JoeThompsonCA",
      tiktok: "JoeThompsonCA",
      facebook: "JoeThompsonCA",
    },
  ...
  {
    name: "Jennifer Esteen",
    identification: "jenniferesteen",
    age: 44,
    county: "Alameda County",
    state: "California",
    photoSrc:
      "https://static.wixstatic.com/media/e2c2a4_10244097aecc41eab1e6dee41c06a5ce~mv2.jpg/v1/crop/x_0,y_0,w_1300,h_1908/fill/w_1072,h_1572,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Scrub%20headshot(1)_edited.jpg",
    repreZent: "FALSE",
    contact: {
  ...
  },
  {
    ...
    repreZent: "FALSE",
    contact: {
      website: "samirahforstatesenate.com",
      x: "IbraheemSamirah",
      instagram: "del.ibraheemsamirah",
      tiktok: "",
      facebook: "https://www.facebook.com/DelegateIbraheemSamirah/",
    },
